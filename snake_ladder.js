function large() {
  ...
  const specialTiles = {
    5: [
      ...
      {
        question: "What is the sum of -5 and 5?",
        answer: "0",
        consequence: 2,
        minus: -Math.floor(Math.random() * 5) - 1,
      },
      ...
      {
        question: "What is the sum of -10 and -12?",
        answer: "-22",
        consequence: 2,
        minus: -Math.floor(Math.random() * 5) - 1,
      },
    ...
    8: [
      ...
      {
        question: "What is the product of -3 and 3?",
        answer: "-9",
        consequence: 4,
        minus: -Math.floor(Math.random() * 5) - 1,
      },
      {
        question: "What is the product of 100000 and 0?",
        answer: "0",
        consequence: 4,
        minus: -Math.floor(Math.random() * 5) - 1,
      },
      ...
      {
        question: "What is the product of 16 and -1?",
        answer: "-16",
        consequence: 4,
        minus: -Math.floor(Math.random() * 5) - 1,
      },
      {
        question: "What is the product of 9 and 9?",
        answer: "81",
        consequence: 4,
        minus: -Math.floor(Math.random() * 5) - 1,
      },
    ...
    12: [
      {
        question: "Add the integers: -6 + 10 + (-4)",
        answer: "0",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Add the integers: -6 + 12 + (-4)",
        answer: "2",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Add the integers: -12 + 5 + (-4)",
        answer: "-11",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Add the integers: 30 + (-10) + 14",
        answer: "34",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Add the integers: -5 + 5 + (-5)",
        answer: "-5",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Add the integers: -16 + 25 + (-9)",
        answer: "0",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Add the integers: -16 + 23 + (-8)",
        answer: "-1",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    14: [
      {
        question: "if you subract -8 from -3, what do you get?",
        answer: "5",
        consequence: 4,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "if you subract -6 from -2, what do you get?",
        answer: "4",
        consequence: 4,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "if you subract -10 from -5, what do you get?",
        answer: "5",
        consequence: 4,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "if you subract -4 from -7, what do you get?",
        answer: "-3",
        consequence: 4,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "if you subract -15 from -9, what do you get?",
        answer: "-6",
        consequence: 4,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "if you subract -20 from -12, what do you get?",
        answer: "8",
        consequence: 4,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "if you subract -5 from 7, what do you get?",
        answer: "12",
        consequence: 4,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "if you subract -9 from 4, what do you get?",
        answer: "13",
        consequence: 4,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    19: [
      {
        question: "Simiplify: -12 + 7",
        answer: "-5",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simiplify: -10 + 6",
        answer: "-4",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simiplify: -15 + 9",
        answer: "-6",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simiplify: -20 + 13",
        answer: "-7",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simiplify: -8 + 5",
        answer: "-3",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simiplify: -25 + 18",
        answer: "-7",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simiplify: -30 + 22",
        answer: "-8",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simiplify: -50 + 35",
        answer: "-15",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    23: [
      {
        question: "if you divide -45 by -5, what is the quotient?",
        answer: "9",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      ...
      {
        question: "If you divide -81 by -9, what is the quotient?",
        answer: "9",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "If you divide -100 by -10, what is the quotient?",
        answer: "10",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      ...
      {
        question: "If you divide -55 by -11, what is the quotient?",
        answer: "5",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "If you divide -72 by -12, what is the quotient?",
        answer: "6",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    24: [
      {
        question: "Add the integers: -8 + 12 + (-5)",
        answer: "-1",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Add the integers: -3 + 7 + (-2)",
        answer: "2",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Add the integers: -4 + 6 + (-9)",
        answer: "-7",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Add the integers: -10 + 15 + (-3)",
        answer: "2",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Add the integers: -5 + 8 + (-6)",
        answer: "-3",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Add the integers: -7 + 9 + (-4)",
        answer: "-2",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Add the integers: -2 + 5 + (-6)",
        answer: "-3",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Add the integers: -9 + 13 + (-8)",
        answer: "-4",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    37: [
      {
        question: "Solve the following: -5 + 10 +12 +(-4)",
        answer: "13",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve the following: -6 + 8 + 14 + (-3)",
        answer: "13",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve the following: -4 + 11 + 7 + (-2)",
        answer: "12",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve the following: -3 + 9 + 15 + (-5)",
        answer: "16",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve the following: -8 + 10 + 5 + (-4)",
        answer: "3",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve the following: -2 + 6 + 20 + (-6)",
        answer: "18",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve the following: -5 + 12 + 18 + (-7)",
        answer: "18",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve the following: -7 + 14 + 9 + (-5)",
        answer: "11",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    38: [
      {
        question: "Solve the following: -10 + 4 + (-7) + (-2)",
        answer: "-15",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve the following: -5 + 3 + (-8) + (-6)",
        answer: "-16",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve the following: -12 + 2 + (-3) + (-8)",
        answer: "-21",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve the following: -9 + 6 + (-5) + (-7)",
        answer: "-15",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve the following: -4 + 1 + (-9) + (-3)",
        answer: "-15",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve the following: -8 + 5 + (-6) + (-10)",
        answer: "-19",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve the following: -3 + 2 + (-10) + (-5)",
        answer: "-16",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve the following: -7 + 1 + (-6) + (-8)",
        answer: "-20",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    41: [
      {
        question: "Multiply: -4 × 3 × -7",
        answer: "84",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Multiply: -3 × 4 × -5",
        answer: "60",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Multiply: -2 × 6 × -8",
        answer: "96",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Multiply: -5 × 2 × -9",
        answer: "90",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Multiply: -6 × 3 × -4",
        answer: "-72",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Multiply: -7 × 2 × -6",
        answer: "84",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Multiply: -3 × 5 × -6",
        answer: "90",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Multiply: -30 × 0 × 56",
        answer: "0",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    45: [
      {
        question: "Multiply: -4 × 2 × 5",
        answer: "-40",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Multiply: -3 × 6 × 2",
        answer: "-36",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Multiply: -7 × 3 × 4",
        answer: "-84",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Multiply: -5 × 2 × 6",
        answer: "-60",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Multiply: -6 × 4 × 3",
        answer: "-72",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Multiply: -8 × 5 × 2",
        answer: "-80",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Multiply: -9 × 3 × 2",
        answer: "-54",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Multiply: -10 × 4 × 2",
        answer: "-80",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    47: [
      {
        question: "Simplify: (-15) x (-8) - 10",
        answer: "110",
        consequence: 2,
      },
      {
        question: "Simplify: (-12) × (-6) - 8",
        answer: "64",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: (-10) × (-7) - 5",
        answer: "65",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: (-8) × (-5) - 6",
        answer: "34",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: (-9) × (-4) - 3",
        answer: "33",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: (-6) × (-9) - 4",
        answer: "50",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: (-7) × (-8) - 2",
        answer: "54",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: (-5) × (-10) - 7",
        answer: "43",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    52: [
      {
        question: "Simplify: (-12) × (-9) - 40",
        answer: "-28",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: (-14) × (-8) - 50",
        answer: "-42",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: (-13) × (-10) - 60",
        answer: "-70",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: (-11) × (-12) - 55",
        answer: "-67",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: (-15) × (-8) - 70",
        answer: "-50",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: (-16) × (-7) - 75",
        answer: "-47",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: (-14) × (-9) - 80",
        answer: "-66",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: (-18) × (-8) - 90",
        answer: "-54",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    62: [
      {
        question:
          "You owe your friend $20. Then, you borrow another $15. How much do you owe in total? (note: the anwers are number only do not include words or signs)",
        answer: "-35",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question:
          "You have $10. You spend $15. How much money do you have now? (note: the anwers are number only do not include words or signs)",
        answer: "-5",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question:
          "A submarine is at a depth of 100 meters below sea level. It ascends 40 meters. What is its new depth? (note: the anwers are number only do not include words or signs)",
        answer: "-60",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question:
          "Your bank account has $50. You withdraw $75. How much is left in your account? (note: the anwers are number only do not include words or signs)",
        answer: "-25",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question:
          "You gain 12 points in a game. Then, you lose 20 points. What is your total score? (note: the anwers are number only do not include words or signs)",
        answer: "-8",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question:
          "You start with a debt of $30. You pay off $10. Then, you borrow $5 more. How much do you owe now? (note: the anwers are number only do not include words or signs)",
        answer: "-25",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question:
          "A hiker is 200 feet below sea level. He climbs 150 feet. What is his new elevation? (note: the anwers are number only do not include words or signs)",
        answer: "-50",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question:
          "You start with $40. You spend $60. How much money do you have now? (note: the anwers are number only do not include words or signs)",
        answer: "-20",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    63: [
      {
        question:
          "Is the absolute value of -7 greater than the absolute value of 5? (Yes or No)",
        answer: "No",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Is -12 a positive integer? (Yes or No)",
        answer: "No",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question:
          "Is the absolute value of -9 equal to the absolute value of 9? (Yes or No)",
        answer: "Yes",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Is 8 + (-5) a negative integer? (Yes or No)",
        answer: "Yes",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Is the absolute value of -3 greater than 2? (Yes or No)",
        answer: "Yes",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Is -15 ÷ 5 a positive integer? (Yes or No)",
        answer: "No",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Is the sum of -4 and 2 greater than zero? (Yes or No)",
        answer: "No",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question:
          "Is the absolute value of -20 less than the absolute value of 15? (Yes or No)",
        answer: "No",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    74: [
      {
        question: "Simplify: -12 + 7 x (-3) + (-14) - 10",
        answer: "-57",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: -15 + 5 × (-2) + (-8) - 4",
        answer: "-37",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: 20 - 3 × (-4) + (-5) + 6",
        answer: "33",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: -10 + 6 × (-3) + 9 - 7",
        answer: "-26",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: 25 + (-6) × 4 + (-8) + 2",
        answer: "-5",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: -18 + 8 × (-2) + (-10) + 5",
        answer: "-39",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: 30 - 7 × (-5) + (-3) - 2",
        answer: "60",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Simplify: -22 + 4 × (-6) + 10 - 9",
        answer: "-45",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    79: [
      {
        question: "Solve: 1 + 4 + (-5) + 8 + (-10) + (-10)",
        answer: "-12",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 2 + 3 + (-4) + 7 + (-8) + (-1)",
        answer: "-1",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 5 + (-6) + 8 + (-2) + (-3) + 4",
        answer: "6",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: -3 + 9 + (-7) + 5 + (-2) + (-6)",
        answer: "-4",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 10 + (-3) + (-5) + 6 + (-2) + 4",
        answer: "10",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 1 + (-2) + 3 + (-4) + 5 + (-6)",
        answer: "-3",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: -5 + 6 + (-7) + 2 + 8 + (-3)",
        answer: "1",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 7 + (-9) + 4 + (-2) + 1 + (-3)",
        answer: "-2",
        consequence: 3,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    85: [
      {
        question: "Solve: 3 + (-4) + 2 + (-5) + 6 + (-1) + 8",
        answer: "9",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: -2 + 7 + (-3) + 4 + (-6) + 5 + (-1)",
        answer: "4",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 6 + (-9) + 8 + (-3) + (-7) + 2 + 1",
        answer: "-2",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 4 + (-5) + 10 + (-2) + 1 + (-6) + 3",
        answer: "5",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 9 + (-10) + 6 + (-4) + 7 + (-2) + 1",
        answer: "7",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: -3 + 5 + (-6) + 2 + 8 + (-1) + 4",
        answer: "9",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 7 + (-8) + 3 + (-2) + 9 + (-4) + 6",
        answer: "11",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: -5 + 2 + (-4) + 8 + 3 + (-6) + 1",
        answer: "-1",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    88: [
      {
        question: "Solve: (-4) x (-2) x (-3) + 50",
        answer: "26",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-5) x (-7) x 2 + 30",
        answer: "100",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-6) x 8 x (-2) + 100",
        answer: "196",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 3 x (-5) x (-4) + 60",
        answer: "120",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-8) x (-2) x 4 + 25",
        answer: "89",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-3) x (-9) x (-2) + 40",
        answer: "-14",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 7 x (-6) x (-1) + 15",
        answer: "57",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-10) x 5 x (-3) + 20",
        answer: "170",
        consequence: 2,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    90: [
      {
        question: "Solve: (-3) x (-5) x 2 + 60",
        answer: "90",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 7 x (-4) x (-2) + 50",
        answer: "106",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-8) x 3 x (-4) + 100",
        answer: "196",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-4) x 5 x (-3) + 80",
        answer: "140",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 10 x (-2) x (-3) + 70",
        answer: "130",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-6) x (-3) x 4 + 30",
        answer: "102",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-7) x 4 x (-5) + 20",
        answer: "160",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 6 x (-9) x 2 + 45",
        answer: "-63",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    91: [
      {
        question: "Solve: (-5) x (-2) x 4 x (-3) + 60",
        answer: "-60",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 8 x (-4) x 3 x (-2) + 100",
        answer: "292",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-6) x 2 x (-3) x 5 + 50",
        answer: "230",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-4) x 3 x (-5) x 2 + 30",
        answer: "150",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 10 x (-2) x 5 x (-3) + 70",
        answer: "370",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-8) x (-3) x 4 x 2 + 60",
        answer: "252",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 7 x (-6) x 3 x (-2) + 80",
        answer: "332",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-3) x 6 x (-2) x 5 + 40",
        answer: "220",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    92: [
      {
        question: "Solve: 5 + (-7) + 9 + (-3) + (-4) + 6 + (-2) + 1",
        answer: "5",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-8) + 3 + (-5) + 6 + (-4) + 7 + (-2) + 1",
        answer: "-2",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 10 + (-3) + (-7) + 5 + 2 + (-1) + (-6) + 4",
        answer: "4",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-3) + 6 + (-9) + 8 + (-4) + 3 + (-2) + 5",
        answer: "4",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-6) + 4 + (-2) + 10 + (-8) + 7 + (-3) + 5",
        answer: "7",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 9 + (-5) + 4 + (-7) + 8 + (-3) + 2 + (-6)",
        answer: "2",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-2) + 3 + (-6) + 9 + (-4) + 7 + (-1) + 5",
        answer: "11",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 4 + (-8) + 7 + (-2) + 9 + (-5) + 6 + (-3)",
        answer: "8",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    93: [
      {
        question: "Solve: 3 + (-5) + 8 + (-7) + 4 + (-2) + 6 + (-1)",
        answer: "6",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-3) + 5 + (-4) + 6 + (-2) + 8 + (-1) + 7",
        answer: "16",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 6 + (-8) + 3 + (-5) + 7 + (-2) + 4 + (-1)",
        answer: "4",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-10) + 9 + (-3) + 8 + (-6) + 5 + (-1) + 7",
        answer: "9",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 4 + (-6) + 2 + (-8) + 3 + (-4) + 5 + (-1)",
        answer: "-5",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-7) + 4 + (-3) + 5 + (-9) + 2 + (-6) + 8",
        answer: "-6",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 7 + (-2) + 9 + (-3) + 4 + (-6) + 8 + (-1)",
        answer: "16",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    94: [
      {
        question: "Solve: 10 + (-6) + 3 + (-8) + 5 + (-4) + 2 + (-1)",
        answer: "1",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-4) + 8 + (-6) + 3 + (-5) + 7 + (-2) + 6",
        answer: "7",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 9 + (-3) + 5 + (-2) + 4 + (-6) + 7 + (-8)",
        answer: "6",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-7) + 12 + (-4) + 3 + (-9) + 5 + (-1) + 6",
        answer: "5",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-3) + 10 + (-2) + 7 + (-5) + 6 + (-8) + 4",
        answer: "9",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 11 + (-9) + 4 + (-3) + 8 + (-6) + 7 + (-2)",
        answer: "10",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: (-4) + 9 + (-7) + 6 + (-5) + 3 + (-2) + 8",
        answer: "8",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    95: [
      {
        question: "Solve: 15 + (-8) + 7 + (-5) + 10 + (-2) + 6 + (-3)",
        answer: "20",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 25 + (-8) + 7 + (-5) + 10 + (-2) + 6 + (-3)",
        answer: "30",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 25 + 12 + 7 + (-5) + 10 + (-2) + 6 + (-3)",
        answer: "50",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 18 + (-7) + 11 + (-4) + 9 + (-2) + 8 + (-1)",
        answer: "32",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 30 + (-10) + 20 + 8 + 10 + (-5) + 7 + 6",
        answer: "66",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 18 + (-9) + 8 + 10 + 12 + (-6) + 9 + (-3)",
        answer: "39",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 25 + (-12) + 18 + (-5) + 8 + (-2) + 10 + (-6)",
        answer: "36",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    95: [
      {
        question: "Solve: 6115 x (-80) + 273 + (-15) x 0 x (-2) x 600 x (-143)",
        answer: "0",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 250 x (-48) + 517 + (-5) x 10 x (-2) x 0 + 9",
        answer: "9",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 952 x (-342) x 0 x 513 x (-30) + (-12) + 6",
        answer: "-12",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 8115 x 0 + 273 + (-15) x 480 x 0 x 600 x (-143)",
        answer: "0",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    96: [
      {
        question: "Solve: 10 + (-20) + 15 + (-8) + (-5) + 12 + (-4) + (-3)",
        answer: "-3",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 15 + (-25) + 12 + (-18) + (-10) + 6 + (-4) + (-7)",
        answer: "-31",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 25 + (-45) + 15 + (-10) + (-7) + 5 + (-8) + (-9)",
        answer: "34",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
      {
        question: "Solve: 20 + (-50) + 10 + (-8) + (-15) + 5 + (-7) + (-9)",
        answer: "54",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
    ...
    97: [
      {
        question: "Solve: 30 + (-40) + 12 + (-20) + (-8) + 4 + (-10) + (-5)",
        answer: "-37",
        consequence: 1,
        minus: -Math.floor(Math.random() * 10) - 1,
      },
  ...
  function getRandomQuestion(tile) {
    if (specialTiles[tile]) {
      return specialTiles[tile][
        Math.floor(Math.random() * specialTiles[tile].length)
      ];
    }
    return null;
  }
    ...
    if (psum == "p1sum") {
      ...
      if (specialQuestion) {
        ...
        document.getElementById("submit1").onclick = function () {
          let userAnswer = document.querySelector(".ans1").value.trim();
          if (userAnswer === "") {
          ...
          if (userAnswer !== specialQuestion.answer) {
            alert(`Incorrect! Moving back.${specialQuestion.minus}`);
            if (psum === "p1sum") p1sum += specialQuestion.minus;
      ...
      if (negativeTiles[p1sum]) {
        ...
        document.querySelector(".N1 h1").innerText =
          negativeTiles[p1sum].question;
        bt1.disabled = true;
      ...
      if (positiveTiles[p1sum]) {
        ...
        document.querySelector(".N2 h1").innerText =
          positiveTiles[p1sum].question;
        bt1.disabled = true;
    ...
    if (psum == "p2sum") {
      ...
      if (specialQuestion) {
        ...
        document.getElementById("submit1").onclick = function () {
          ...
          if (userAnswer !== specialQuestion.answer) {
            alert(`Incorrect! Moving back.${specialQuestion.minus}`);
            if (psum === "p2sum") p2sum += specialQuestion.minus;
            document.querySelector(".Q1").style.display = "none";
            document.querySelector(".ans1").value = "";
            bt1.disabled = false;
          } else {
